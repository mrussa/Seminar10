...
public class DateTimeExample {
    ...
    public static void modernDateTimeClasses() {
        ...
        LocalDateTime anotherLocalDateTime = LocalDateTime.of(2049, 12, 13, 15, 30);
        ...
        OffsetDateTime anotherOffsetDateTime = OffsetDateTime.of(anotherLocalDateTime, ZoneOffset.of("+9"));
    ...
    public static void modernDateTimeExample() {
        ...
        LocalDateTime alteredNow = now.plus(3, ChronoUnit.HOURS).plusSeconds(153).withMinute(0);
