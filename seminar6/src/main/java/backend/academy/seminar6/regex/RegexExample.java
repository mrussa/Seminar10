...
public class RegexExample {
    ...
    public static void basicExample() {
        ...
        Matcher helloWorldMatcher = regex.matcher("Hello World!");
        logger.info("Find in helloWorld result: {}", helloWorldMatcher.find()); // true

        Matcher welcomeToJavaMatcher = regex.matcher("Welcome to Java!");
        logger.info("Find in welcomeToJava result: {}", welcomeToJavaMatcher.find()); // false

        Matcher justWorldMatcher = regex.matcher("World");
    ...
    public static void isValidEmail(String email) {
        ...
        // find() will also match entire string
